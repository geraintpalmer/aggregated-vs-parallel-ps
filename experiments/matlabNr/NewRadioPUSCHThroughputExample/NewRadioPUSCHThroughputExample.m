...
simParameters.SNRIn = [-5 0 5 20]; % SNR range (dB)
simParameters.SNRIn = [0 5 10]; % SNR range (dB)
...
simParameters.PUSCH.NumLayers = 2;              % Number of PUSCH transmission layers
...
simParameters.PUSCH.Modulation = '256QAM'; % 'pi/2-BPSK', 'QPSK', '16QAM', '64QAM', '256QAM'
...
simParameters.NRxAnts = 8; % Number of receive antennas
